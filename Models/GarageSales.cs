...
namespace ReSell.Models
{
    public class GarageSales
    {
        ...
        [StringLength(5, ErrorMessage = "Please enter the item you have for sale!")]
        public string PostingTitle { get; set; }
        [Required]
        [StringLength(50, ErrorMessage = "Please enter the address where the garage sale is located.")]
